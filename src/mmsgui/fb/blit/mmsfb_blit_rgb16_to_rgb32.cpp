...
void mmsfb_blit_rgb16_to_rgb32(MMSFBSurfacePlanes *src_planes, int src_height, int sx, int sy, int sw, int sh,
	...
	if (firsttime) {
		printf("DISKO: Using accelerated conversion RGB16 to RGB32.\n");
		firsttime = false;
	}

	// no difference to argb, use rgb16 to argb routine
	mmsfb_blit_rgb16_to_argb(src_planes, src_height, sx, sy, sw, sh,
