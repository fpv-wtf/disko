...
MMS3DCylinder::MMS3DCylinder(MMS3DScene *scene,
								int material, int texture,
								int numSlices, float height, float radius) : MMS3DObject(scene, material, texture) {
	...
	// generate mesh
	this->scene->mms3dpm.genCylinder(numSlices, height, radius,
										&obj->vertices,
										&obj->normals,
